...
SamplerState tWeightMap0_sampler : register(s0);
SamplerState tDetailMap1_sampler : register(s1);
SamplerState tDetailMap2_sampler : register(s2);
SamplerState tDetailMap3_sampler : register(s3);
#else
Texture2D tWeightMap0 : register(t0);
Texture2D tDetailMap1 : register(t1);
Texture2D tDetailMap2 : register(t2);
...
void VS(float4 iPos : POSITION,
    ...
    #endif
    #if (defined(D3D11) || defined(DILIGENT)) && defined(CLIPPLANE)
